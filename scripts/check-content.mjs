...
const expectedFolders = {
  ko: { 컴퓨팅: 'computing', 공학: 'engineering', 기록: 'records', 추천: 'recommendations' },
  en: { Computing: 'computing', Engineering: 'engineering', Notes: 'records', Recommendations: 'recommendations' }
};
