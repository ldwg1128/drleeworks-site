...
- 포식자는 일정시간 피식자를 섭취하지 못하면 사멸
- 피식자는 일정시간 후 두 개로 복제, 크기와 속도 랜덤하게 변화

어떤 population dynamics나 형질 변화가 나타날지는 parameter에 따라 달라진다. 포식자의 주기적 진동, 한 종의 멸종, 특정 형질의 증가 같은 결과를 코드로 보장하지 않는다.
