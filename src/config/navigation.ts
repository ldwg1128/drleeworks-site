...
export function getSidebarNavigation(lang: Lang): SidebarGroup[] {
  ...
  return [
    ...
    { items: [{ path: '/computing', label: t.computing }, { path: '/engineering', label: t.engineering }, { path: '/notes', label: t.notes }, { path: '/recommendations', label: t.recommendations }, { path: '/interactive', label: t.interactive }] },
